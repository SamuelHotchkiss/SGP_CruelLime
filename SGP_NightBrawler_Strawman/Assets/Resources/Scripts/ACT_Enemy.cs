...
/// <Behavior Variables>
	...
	public void OnGUI()
	{
		if (cam != null)
		{
			...
			GUI.Box(new Rect(targetPos.x - 50, Screen.height - targetPos.y - 150, 100, 6), "", BlackBar);
			GUI.Box(new Rect(targetPos.x - 50, Screen.height - targetPos.y - 150, 100 * ((float)Act_currHP / (float)Act_baseHP), 6), "", HealthBar);
		}
	}
}
